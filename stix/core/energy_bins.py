#a class to store STIX energy bins
# it has been updated 
import time
...
class StixEnergyBins:
    ...
    _history = [
        {
            'time_ranges': [1690761600, MISSION_END_TIME],  # 2023-07-31T00:00:00 to sometime in the future
        ...
        {
            'time_ranges': [1675036800, 1675353600],  # 2023-01-30 to 2023-02-02T16:00
    ...
    def get_energy_bins( unix_time=0):
        ...
        for entry in StixEnergyBins._history:
            if entry['time_ranges'][0] <= unix_time < entry['time_ranges'][1]:
