...
class Calibration(object):
    ...
    STEPS=10000
    FIT_RANGE_SMALL_MARGIN = 2
    FIT_RANGE_BIG_MARGIN= 8
    PEAK_MIN_COUNTS = 50
    ELUT_ENERGIES = [
    ...
    def find_solution(self, detector, pixel, sbspec_id,spectrum, start_ch, bin_width, pdf=None):
        ...
        peak1_x, peak1_y, peak1_pos=select_near_max(spec_x,spec_y, 
                peak1_pos-2*Calibration.FIT_RANGE_SMALL_MARGIN, peak1_pos+Calibration.FIT_RANGE_SMALL_MARGIN, 
                #bin_width, bin_width)
                2*Calibration.FIT_RANGE_SMALL_MARGIN, 2*Calibration.FIT_RANGE_SMALL_MARGIN)
        ...
        #plt.plot(peak1_x, peak1_y)
        #plt.plot(peak2_x, peak2_y)
        #plt.show()


        low_e_1_result=PeakFitting.fit_gaus(peak1_x,peak1_y,  0, 1,peak1_pos, 1, bin_width)
        low_e_2_result=PeakFitting.fit_gaus(peak2_x,peak2_y,  0, 1,peak2_pos,1, bin_width)
        #print(low_e_1_result.fit_report())
        #print(low_e_2_result.fit_report())
        #print(low_e_1_result)
