...
def download_fermi_sunward_detector_data(start_utc,
                                         end_utc,
                                         folder='.',
                                         download_tte=True):
    """ 
    ...
    """
    detector_names = ('n0', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8',
                      'n9', 'na', 'nb')  #, 'b0', 'b1')
    ...
    delta_times = [
        timedelta(seconds=sec) for sec in np.arange(0, duration, dt_step)
    ]
    last_date = None
...
def plot_fermi_gdm_lightcurve_spectrum(start_utc='',
                                       end_utc='',
                                       bkg_start=None,
                                       bkg_end=None,
                                       energy_range=(10, 26),
                                       ...
                                       flare_id='',
                                       entry_id=''):
    res = download_fermi_sunward_detector_data(start_utc, end_utc,
                                               cache_folder)
    #print(res)
    if not res['tte']:
...
def plot_fermi_for_flare(image_folder, cache_folder, _id, overwrite=False):
    ...
    fname = plot_fermi_gdm_lightcurve_spectrum(start_utc,
                                               end_utc,
