FUNCTION stx_mem_ge_imaging_pipeline,vis,imsize,pixel,aux_data,silent=silent, total_flux=total_flux, percent_lambda=percent_lambda
  ...
  method     = 'MEM_GE'
  mem_ge_map = stx_make_map_imaging_pipeline(mem_ge_im, aux_data, pixel, method, vis)
