...
;           (default, 0)
;           
;   bp_map_full_disk: output, full-disk back projection map computed for estimating the flare location
;
; HISTORY: October 2022, Massa P. (WKU), initial release
;          April 2023, Massa P. (WKU), added bp_nat_map output keywords
;
; CONTACT:
;   paolo.massa@wku.edu
;-
...
pro stx_estimate_flare_location, path_sci_file, time_range, aux_data, flare_loc=flare_loc, path_bkg_file=path_bkg_file, $
  ...
  subc_index=subc_index, silent=silent, this_win=this_win, bp_map_full_disk=bp_nat_map, _extra=extra
