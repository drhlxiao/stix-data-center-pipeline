...
function stx_vis_fwdfit_pso_imaging_pipeline, configuration, vis, aux_data, $
  srcin = srcin, $
  ...
  fwdfit_pso_map = stx_make_map_imaging_pipeline(param_out.data, aux_data, pixel, "FWDFIT_PSO", vis)
