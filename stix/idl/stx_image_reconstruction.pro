PRO stx_image_reconstruct, path_bkg_file, path_sci_file, $
  ...
  full_disk_bp_map.rtime= flare_start_UTC
...
duration=anytim( flare_end_UTC, /system) - anytim(flare_start_UTC, /system)
  ...
  bp_map.roll_center = [x_offset_arcsec, y_offset_arcsec]
  bp_map.rtime= flare_start_UTC
  bp_map.dur=duration
  ...
  vis_fwdfit_pso_map.roll_center = [x_offset_arcsec, y_offset_arcsec]
  vis_fwdfit_pso_map.rtime= flare_start_UTC
  ...
  clean_map.roll_center = [x_offset_arcsec, y_offset_arcsec]
  clean_map.rtime= flare_start_UTC
  ...
  em_map.roll_center = [x_offset_arcsec, y_offset_arcsec]
  em_map.rtime= flare_start_UTC
  em_map.dur=duration
