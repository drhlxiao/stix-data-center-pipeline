PRO stx_image_reconstruct, path_bkg_file, path_sci_file, $
	...
	vis  = stix2vis_sep2021(path_sci_file, time_range, energy_range, full_disk_bp_map_mapcenter, aux_data, subc_index=full_disk_bp_map_subc_index, $
...
;full_disk_bp_map.dur=duration
	...
	vis  = stix2vis_sep2021(path_sci_file, time_range, energy_range, max_bp_coord, aux_data,$
...
;	clean_map.dur=duration
	...
	em_map = stx_em(data.RATE_PIXEL,energy_range,time_range,aux_data, IMSIZE=map_size,PIXEL=pixel_size,MAPCENTER=max_bp_coord, $
